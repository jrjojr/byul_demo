...
class ToolbarPanel(QToolBar):
    ...
    def __init__(self, actions:Actions, parent):
        ...
        self.addAction(self.actions.clear_path_action)
        self.addAction(self.actions.view_proto_path_action)
        self.addAction(self.actions.view_real_path_action)
        self.addAction(self.actions.clear_proto_path_action)
        self.addAction(self.actions.clear_real_path_action)        
